...
export type slideChangeMutation = { __typename?: "Mutation"; slideChange: boolean }
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [{ kind: "Field", name: { kind: "Name", value: "slide" } }],
            },
          },
        ],
      },
...
} as unknown as DocumentNode<slideChangedSubscription, slideChangedSubscriptionVariables>
