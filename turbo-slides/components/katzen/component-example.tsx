...
import { CopyButton, CopyWithClassNames } from '@/components/katzen/copy-button'
      ...
      <Tabs defaultValue="preview" className="mr-auto w-full">
        ...
        <TabsContent value="code">
          <div className="flex flex-col space-y-4">
            ...
            {Children?.length ? (
              <div className="rounded-md [&_button]:hidden [&_pre]:my-0 [&_pre]:max-h-[350px] [&_pre]:overflow-auto">{Children}</div>
            ) : null}
          </div>
        </TabsContent>
      </Tabs>
